...
import (
	...
	backupdef "github.com/dalet-oss/arangodb-operator/pkg/apis/backup"
	depldef "github.com/dalet-oss/arangodb-operator/pkg/apis/deployment"
	deplapi "github.com/dalet-oss/arangodb-operator/pkg/apis/deployment/v1"
	repldef "github.com/dalet-oss/arangodb-operator/pkg/apis/replication"
	replapi "github.com/dalet-oss/arangodb-operator/pkg/apis/replication/v1"
	lsapi "github.com/dalet-oss/arangodb-operator/pkg/apis/storage/v1alpha"
	"github.com/dalet-oss/arangodb-operator/pkg/deployment"
	...
	"github.com/dalet-oss/arangodb-operator/pkg/handlers/backup"
	"github.com/dalet-oss/arangodb-operator/pkg/handlers/job"
	"github.com/dalet-oss/arangodb-operator/pkg/handlers/policy"
	"github.com/dalet-oss/arangodb-operator/pkg/logging"
	"github.com/dalet-oss/arangodb-operator/pkg/operator/scope"
	operatorV2 "github.com/dalet-oss/arangodb-operator/pkg/operatorV2"
	"github.com/dalet-oss/arangodb-operator/pkg/operatorV2/event"
	"github.com/dalet-oss/arangodb-operator/pkg/replication"
	"github.com/dalet-oss/arangodb-operator/pkg/storage"
