...
import (
	...
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/arangoclustersynchronization"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/arangodeployment"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/arangomember"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/arangotask"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/endpoints"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/mods"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/node"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/persistentvolume"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/persistentvolumeclaim"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/pod"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/poddisruptionbudget"
	...
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/server"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/service"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/serviceaccount"
	"github.com/dalet-oss/arangodb-operator/pkg/util/k8sutil/inspector/servicemonitor"
